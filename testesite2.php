...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO tb_usuarioteste (nm_usuario, id_email, id_idade, id_genero) VALUES (?, ?, ?, ?)");
        $stmt->execute([$nome, $email, $idade, $genero]);
...
?>
   	...
   	<section class="enquete">
		...
		<h2>Informe o seu veículo, e lhe indicaremos vídeos sobre o mesmo:</h2>
		...
		<label for="motor">Qual o motor do seu carro?</label>
        <select name="motor">
            <option value="">Selecione</option>
            <option value="1.016">1.0 16v</option>
            <option value="1.08">1.0 8v</option>
            <option value="1.48">1.4 8v</option>
            <option value="1.68">1.6 8v</option>
            <option value="1.616">1.6 16v</option>
            <option value="2.08">2.0 8v</option>
			<option value="2.016">2.0 16v</option>
        </select><br><br>
		...
		<label for="video">videos dos problemas do seu carro</label>
        <select name="video">
            <option value="">Selecione</option>
            <option value="vazamento">Vazamento</option>
            <option value="suspensão">Suspensão</option>
            <option value="oleo">Queima de óleo</option>
